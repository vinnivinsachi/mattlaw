                                   ...
                                   $template='<li>%s</li>')
    {
        ...
        */
        ...
        if($messages) {
	        ...
	        // Seperate messages into appropriate categories
	        foreach ($messages as $message) {
	        	if(is_array($message)) {
	        		list($key, $message) = each($message);
	        	}
	        ...
	        // build message HTML
	        $output ='<div id="flash-messages" class="RialtoFlashMessage">';
	        ...
	        return $output; // Return the messages
        }
        else return ''; // return nothing is NO messages
    }
